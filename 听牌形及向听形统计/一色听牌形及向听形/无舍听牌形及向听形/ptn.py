...
def findtenpai(agari):
	...
	tenpaiset = [[], [], [], []]
	for i in range(4):
		tenpai[i] = [[] for k in range(14)]
		tenpaiset[i] = [[] for k in range(14)]
		for j in range(14):
			tenpaiset[i][j] = set()
...
def main():
	...
	# # find 0 ~ 14 (1 ~ 14 needed) normal agari pattern
	...
	# # find 0 ~ 14 (1 ~ 14 needed) normal & toitsu agari pattern
	...
	# normal & toitsu shanten1 pattern
	...
	# normal & toitsu shanten2 pattern
	...
	# normal & toitsu shanten3 pattern
	...
	# normal & toitsu shanten4 pattern
	...
	# normal & toitsu shanten5 pattern
	...
	# # [Error]: remain = [[[] for k in range(14)]] * 4
	...
	# remain = [[[] for k in range(14)], [[] for k in range(14)], [[] for k in range(14)], [[] for k in range(14)]]
	# shanten = [[], [], [], [], []]
	# for s in range(5):
	# 	for i in range(4):
	# 		for j in range(14):
